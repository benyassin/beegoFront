(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('formiojs'), require('@angular/router'), require('lodash'), require('@angular/common'), require('@angular/forms'), require('rxjs'), require('ngx-bootstrap/pagination')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'formiojs', '@angular/router', 'lodash', '@angular/common', '@angular/forms', 'rxjs', 'ngx-bootstrap/pagination'], factory) :
	(factory((global['formio-manager'] = {}),global.core,global.formiojs,global.router,global._,global.common,global.forms,global.rxjs,global.pagination));
}(this, (function (exports,core,formiojs,router,_,common,forms,rxjs,pagination) { 'use strict';
...
var FormManagerViewComponent = /** @class */ (function () {
    function FormManagerViewComponent(service, router$$1, route) {
        this.service = service;
        this.router = router$$1;
        this.route = route;
    }
...
var FormManagerEditComponent = /** @class */ (function () {
    function FormManagerEditComponent(service, router$$1, route, config, ref) {
        this.service = service;
        this.router = router$$1;
        this.route = route;
        this.config = config;
...
var FormManagerDeleteComponent = /** @class */ (function () {
    function FormManagerDeleteComponent(service, router$$1, route) {
        this.service = service;
        this.router = router$$1;
        this.route = route;
    }
...
var SubmissionDeleteComponent = /** @class */ (function () {
    function SubmissionDeleteComponent(service, router$$1, route) {
        this.service = service;
        this.router = router$$1;
        this.route = route;
    }
