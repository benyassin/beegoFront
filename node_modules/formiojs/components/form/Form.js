...
function (_BaseComponent) {
  ...
  _createClass(FormComponent, [{
    ...
    value: function loadSubForm() {
      ...
      if (this.subFormLoaded || !_get(_getPrototypeOf(FormComponent.prototype), "checkConditions", this).call(this, this.root ? this.root.data : this.data)) {
    ...
    value: function checkConditions(data) {
      ...
      return _get(_getPrototypeOf(FormComponent.prototype), "checkConditions", this).call(this, data);
    }
  }, {
    key: "calculateValue",
