    ...
    value: function buildPageBar() {
      ...
      _lodash.default.each(pages, function (page, index) {
        var pageLink = _this3.ce('span', {
          title: page.title,
          class: index === _this3.currentPage ? 'mr-2 badge badge-primary label label-primary wizard-page-label' : 'mr-2 badge badge-info label label-info wizard-page-label'
